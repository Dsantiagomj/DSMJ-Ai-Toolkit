...
**Why**: Selecting only needed fields reduces data transfer and prevents exposing sensitive data. See [queries.md](./references/queries.md) for advanced patterns.
...
**Why**: Transactions ensure atomicity - all operations succeed or all fail. See [queries.md](./references/queries.md) for more transaction patterns.
...
**Why**: Proper indexing dramatically improves query performance. See [schema.md](./references/schema.md) for indexing strategies.
...
For more anti-patterns and best practices, see [references/queries.md](./references/queries.md) and [references/migrations.md](./references/migrations.md).
...
For field types, relations, and advanced schema patterns, see [schema.md](./references/schema.md).
...
For advanced queries, relations, pagination, filtering, aggregations, and transactions, see [queries.md](./references/queries.md).
